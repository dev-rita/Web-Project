...
<html lang="ko" class="no-js"><!--<![endif]--><head>
		...
		<title>OKKY - JAVA 입문 초보질문이요</title>
	...
	<script src="https://connect.facebook.net/ko_KR/sdk.js?hash=3311e52b353d8131dec5a2c9f3e6759f" async="" crossorigin="anonymous"></script><script id="facebook-jssdk" src="//connect.facebook.net/ko_KR/sdk.js#xfbml=1&amp;appId=1539685662974940&amp;version=v2.0"></script><script src="https://www.googletagservices.com/activeview/js/current/osd.js"></script><script src="https://partner.googleadservices.com/gampad/cookie.js?domain=okky.kr&amp;callback=_gfp_s_&amp;client=ca-pub-8103607814406874&amp;cookie=ID%3D211a8af1bf1f530b-2234a71a69ca00c2%3AT%3D1626532296%3ART%3D1626532296%3AS%3DALNI_Ma3AoN67nu6cpRvWDd1rPPop8KXEg"></script><script src="https://pagead2.googlesyndication.com/pagead/js/r20210720/r20190131/show_ads_impl_fy2019.js" id="google_shimpl"></script><script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script><script async="" src="https://www.googletagmanager.com/gtm.js?id=GTM-M52CW55"></script><script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
...
<div class="avatar clearfix avatar-medium pull-left">
		...
		<div class="avatar-info">
            ...
            <div class="content-identity-count"><i class="fa fa-comment"></i> 7</div>
        ...
        <div class="content-container clearfix">
            <div id="content-body" class="panel-body content-body pull-left">
                <div class="content-tags">
                    <span class="list-group-item-text article-id">#1004902</span>
	<a href="/articles/tech-qna" class="list-group-item-text item-tag label label-info"><i class="fa fa-database"></i> Tech Q&amp;A</a>
			...
			<a href="/articles/tagged/%EC%B6%94%EA%B0%80%EC%A7%88%EB%AC%B8" class="list-group-item-text item-tag label label-gray ">추가질문</a>
                ...
                <article class="content-text" itemprop="articleBody">
                    	<p>제가 요즘 JAVA를 배우고 있는데.. 주변에서 로또 소스 한번 만들어보라고 숙제 아닌 숙제를 주셨는데요.</p><p>제가 지금까지 배운것들을 이용해서 최선을 다해 만들었는데 곰곰히 보니깐 중복되는 소스들이 많더라고요.</p><p>그래서 반복문을 이용해서 더 간결하고 이쁘게 만들고 싶은데 지금에 제 수준으론 한계가 있어 조언을 구하고자 Q&amp;A적어 봅니다.</p><p>{<!-- --></p><p><span style="white-space:pre">		</span>int Num[] = new int[45];&nbsp; &nbsp; //로또 번호들 묶음</p><p><span style="white-space:pre">		</span>int Lotto[] = new int[6];&nbsp; &nbsp; &nbsp;//마지막으로 출력할 로또 번호들</p><p><span style="white-space:pre">			</span></p><p><span style="white-space:pre">			</span></p><p><span style="white-space:pre">			</span>for(int i=0;i&lt;45;i++){<!-- --></p><p><span style="white-space:pre">				</span>Num[i]=i+1;}&nbsp; &nbsp; &nbsp; // 로또번호 생성</p><p><span style="white-space:pre">		</span></p><p><span style="white-space:pre">		</span>int arr = (int)Math.floor(math.random()*45)&nbsp; // arr은 중복을 제외하기 위한 변수</p><p><span style="white-space:pre">		</span>Lotto[0] = Num[arr]<span style="white-space:pre">	</span></p><p><span style="white-space:pre">		</span></p><p><span style="white-space:pre">		</span>do{<!-- --></p><p><span style="white-space:pre">			</span>int arr = (int)Math.floor(math.random()*45)</p><p><span style="white-space:pre">		</span>}</p><p><span style="white-space:pre">			</span>while(Lotto[0] == Num[arr]);</p><p><span style="white-space:pre">		</span>Lotto[1] = Num[arr]</p><p><span style="white-space:pre">		</span></p><p><span style="white-space:pre">		</span>do{<!-- --></p><p><span style="white-space:pre">			</span>int arr = (int)Math.floor(math.random()*45)</p><p><span style="white-space:pre">		</span>}</p><p><span style="white-space:pre">			</span>while(Lotto[0] == Num[arr] || while(Lotto[1] == Num[arr]);</p><p><span style="white-space:pre">		</span>Lotto[2] = Num[arr]</p><p><span style="white-space:pre">		</span></p><p><span style="white-space:pre">		</span>do{<!-- --></p><p><span style="white-space:pre">			</span>int arr = (int)Math.floor(math.random()*45)</p><p><span style="white-space:pre">		</span>}</p><p><span style="white-space:pre">			</span>while(Lotto[0] == Num[arr] || while(Lotto[1] == Num[arr] || while(Lotto[2] == Num[arr] );</p><p><span style="white-space:pre">		</span>Lotto[3] = Num[arr]</p><p><span style="white-space:pre">		</span></p><p><span style="white-space:pre">		</span>do{<!-- --></p><p><span style="white-space:pre">			</span>int arr = (int)Math.floor(math.random()*45)</p><p><span style="white-space:pre">		</span>}</p><p><span style="white-space:pre">			</span>while(Lotto[0] == Num[arr] || while(Lotto[1] == Num[arr] || while(Lotto[2] == Num[arr] || while(Lotto[3] == Num[arr] );</p><p><span style="white-space:pre">		</span>Lotto[4] = Num[arr]</p><p><span style="white-space:pre">		</span></p><p><span style="white-space:pre">		</span>do{<!-- --></p><p><span style="white-space:pre">			</span>int arr = (int)Math.floor(math.random()*45)</p><p><span style="white-space:pre">		</span>}</p><p><span style="white-space:pre">			</span>while(Lotto[0] == Num[arr] || while(Lotto[1] == Num[arr] || while(Lotto[2] == Num[arr] || while(Lotto[3] == Num[arr] || while(Lotto[4] == Num[arr] );</p><p><span style="white-space:pre">		</span>Lotto[5] = Num[arr]</p><p><span style="white-space:pre">		</span></p><p><span style="white-space:pre">		</span>for(int z = 0;z&lt;6;z++){<!-- --></p><p><span style="white-space:pre">			</span>System.out.println(Lotto[z]+"번,|t");}</p><p>}</p>
                </article>
		...
		<div class="note-evaluate-wrapper">
            ...
            <div class="content-function-cog share-btn-wrapper">
				...
				<div class="main-banner-wrapper">
		            ...
		            <!-- 728-90_Ressponsive -->
	            <ins class="adsbygoogle" style="display:inline-block;width:728px;height:90px" data-ad-client="ca-pub-8103607814406874" data-ad-slot="8622179990" data-adsbygoogle-status="done" data-ad-status="filled"><ins id="aswift_0_expand" style="display:inline-table;border:none;height:90px;margin:0;padding:0;position:relative;visibility:visible;width:728px;background-color:transparent;" tabindex="0" title="Advertisement" aria-label="Advertisement"><ins id="aswift_0_anchor" style="display:block;border:none;height:90px;margin:0;padding:0;position:relative;visibility:visible;width:728px;background-color:transparent;"><iframe id="aswift_0" name="aswift_0" style="left:0;position:absolute;top:0;border:0;width:728px;height:90px;" sandbox="allow-forms allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts allow-top-navigation-by-user-activation" width="728" height="90" frameborder="0" src="https://googleads.g.doubleclick.net/pagead/ads?client=ca-pub-8103607814406874&amp;output=html&amp;h=90&amp;slotname=8622179990&amp;adk=3431456933&amp;adf=1152904402&amp;pi=t.ma~as.8622179990&amp;w=728&amp;lmt=1627189752&amp;psa=1&amp;format=728x90&amp;url=https%3A%2F%2Fokky.kr%2Farticle%2F1004902&amp;flash=0&amp;wgl=1&amp;uach=WyJXaW5kb3dzIiwiMTAuMCIsIng4NiIsIiIsIjkyLjAuNDUxNS4xMDciLFtdLG51bGwsbnVsbCxudWxsXQ..&amp;tt_state=W3siaXNzdWVyT3JpZ2luIjoiaHR0cHM6Ly9hdHRlc3RhdGlvbi5hbmRyb2lkLmNvbSIsInN0YXRlIjo3fV0.&amp;dt=1627189752809&amp;bpp=4&amp;bdt=168&amp;idt=43&amp;shv=r20210720&amp;ptt=9&amp;saldr=aa&amp;abxe=1&amp;cookie=ID%3D211a8af1bf1f530b-2234a71a69ca00c2%3AT%3D1626532296%3ART%3D1626532296%3AS%3DALNI_Ma3AoN67nu6cpRvWDd1rPPop8KXEg&amp;correlator=5026386554244&amp;frm=20&amp;pv=2&amp;ga_vid=1490288083.1626532297&amp;ga_sid=1627189753&amp;ga_hid=52732924&amp;ga_fc=0&amp;u_tz=540&amp;u_his=35&amp;u_java=0&amp;u_h=720&amp;u_w=1280&amp;u_ah=720&amp;u_aw=1280&amp;u_cd=24&amp;u_nplug=3&amp;u_nmime=4&amp;adx=279&amp;ady=1919&amp;biw=1023&amp;bih=631&amp;scr_x=0&amp;scr_y=0&amp;eid=42530672%2C20211866%2C21067496&amp;oid=3&amp;pvsid=953390727597564&amp;pem=36&amp;ref=https%3A%2F%2Fokky.kr%2Farticles%2Ftech-qna%3Foffset%3D220%26max%3D20%26sort%3Did%26order%3Ddesc&amp;eae=0&amp;fc=640&amp;brdim=0%2C0%2C0%2C0%2C1280%2C0%2C1280%2C720%2C1039%2C648&amp;vis=1&amp;rsz=%7C%7CeEbr%7C&amp;abl=CS&amp;pfx=0&amp;fu=1024&amp;bc=31&amp;ifi=1&amp;uci=a!1&amp;btvi=1&amp;fsb=1&amp;xpc=oRAZYDjA1i&amp;p=https%3A//okky.kr&amp;dtd=81" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" scrolling="no" allowfullscreen="true" data-google-container-id="a!1" data-google-query-id="CPLsxZm6_fECFcRBnQkdqEAFFw" data-load-complete="true"></iframe></ins></ins></ins>
	            <script>
    ...
    <div class="panel panel-default clearfix">
        ...
        <ul class="list-group">
            <li id="note-title" class="list-group-item note-title">
                <h3 class="panel-title">답변 <span id="note-count">7</span></h3>
            </li>
            	<li class="list-group-item note-item clearfix" id="note-2440396">
...
Lotto<span class="token punctuation">[</span>X<span class="token punctuation">]</span> <span class="token operator">=</span> Num<span class="token punctuation">[</span>arr<span class="token punctuation">]</span></code></pre><p>이 부분이 반복 되고 있으니 X를 변수로 해서 함수로 따로 빼면 코드양을 확줄일수 있겠네요~</p>
                                </article>
                            </fieldset>
                        </div>
		...
		<div class="note-evaluate-wrapper">
			...
			<div id="content-vote-count-2440396" class="content-eval-count">1</div>
            	...
            	<li class="list-group-item note-item clearfix" id="note-2440404">
...
<div class="avatar clearfix avatar-medium ">
						...
						<span class="date-saperate">∙</span> <a href="/changes/2440404"><span class="timeago" title="2021-07-21 16:19:36">2021-07-21 16:19:36</span> 수정됨 </a>
                            ...
                            <fieldset class="form">
                                <article id="note-text-2440404" class="list-group-item-text note-text">
				                    	<p>그리고 while문에서 하나씩 조건이 추가되면서 판단하면... </p><p>내부적으로 만족하는 값이 나올때까지 계속 반복문을 돌겠죠?</p><p>저가 만약 짠다면 반복문 하나로 로또숫자 배열에 값을 1부터45까지 세팅해주고~&nbsp;</p><p>함수 돌때마다 배열 길이범위의 Random 값 구해서..&nbsp;</p><p>해당 값의 index자리 값을 배열에서 빼주는 식으로 하면 중복검사 반복문도 필요없을듯하네용</p><p><br></p>
                                </article>
                            </fieldset>
                        </div>
		...
		<div class="note-evaluate-wrapper">
			...
			<div id="content-vote-count-2440404" class="content-eval-count">1</div>
            	...
            	<li class="list-group-item note-item clearfix" id="note-2440406">
            		<form action="/content/update/2440406" method="post" data-id="2440406" class="note-update-form">
            			<input type="hidden" name="_method" value="PUT" id="_method">
                        <div class="content-body panel-body pull-left">
                        				<div class="note-select-indicator note-deselected">
                                            <i class="fa fa-comment"></i>
...
<div class="avatar clearfix avatar-medium ">
		...
		<div class="avatar-info">
				<a class="nickname" href="/user/info/93886" title="퀘이사123">퀘이사123</a>
					...
					<div class="date-created"><span class="timeago" title="2021-07-21T16:17:30">2021-07-21 16:17:30</span></div>
		</div>
</div>
                            <fieldset class="form">
                                <article id="note-text-2440406" class="list-group-item-text note-text">
				                    	<p><span style="color:rgb( 51 , 51 , 51 )">단순히 로또번호 6개 뽑는거면</span></p><p><span style="color:rgb( 51 , 51 , 51 )">번호 6개 담을 배열을 만든다.</span></p><p><span style="color:rgb( 51 , 51 , 51 )">배열이 다 찰때까지 무한루프를 돌린다.</span></p><p><span style="color:rgb( 51 , 51 , 51 )">1~45까지 랜덤으로 뽑는다.</span></p><p><span style="color:rgb( 51 , 51 , 51 )">배열에 넣는다.</span></p><p><span style="color:rgb( 51 , 51 , 51 )">중복값이 있으면 넣지 않는다.</span></p><p><span style="color:rgb( 51 , 51 , 51 )"><br></span></p><p><span style="color:rgb( 51 , 51 , 51 )">로 하면 되죠.</span></p><p><span style="color:rgb( 51 , 51 , 51 )"><br></span></p><p><span style="color:rgb( 51 , 51 , 51 )">필요없는 코드들이 좀 많은거 같긴한데.</span></p><p><span style="color:rgb( 51 , 51 , 51 )"><br></span></p><p><span style="color:rgb( 51 , 51 , 51 )">int Lotto[] = new int[6];&nbsp; 배열은 이거 하나만 잇으면 되고</span></p><p><span style="color:rgb( 51 , 51 , 51 )">무한루프 안에서</span></p><p><span style="color:rgb( 51 , 51 , 51 )">랜덤값 뽑고 중복안되게 넣고(for 문 잘돌리세요.)하면됩니다.</span></p>
                                </article>
                            </fieldset>
                        </div>
		...
		<div class="note-evaluate-wrapper">
				<a href="javascript://" class="note-vote-btn" role="button" data-type="assent" data-eval="true" data-id="2440406">
					<i id="note-evaluate-assent-2440406" class="fa fa-angle-up note-evaluate-assent-assent" data-placement="left" data-toggle="tooltip" title="" data-original-title="추천"></i>
				</a>
			
			<div id="content-vote-count-2440406" class="content-eval-count">1</div>
			
				<a href="javascript://" class="note-vote-btn" role="button" data-type="dissent" data-eval="true" data-id="2440406">
					<i id="note-evaluate-dissent-2440406" class="fa fa-angle-down note-evaluate-dissent-dissent" data-placement="left" data-toggle="tooltip" title="" data-original-title="반대"></i>
				</a>
		</div>
                            </div>
                        </div>
                    </form>
					<form action="/content/delete/2440406" method="post" id="note-delete-form-2440406">
							<input type="hidden" name="_csrf" value="5483808e-cec5-4b25-978e-5953710310a7">
						<input type="hidden" name="_method" value="DELETE" id="_method">
                    </form>
                </li>
            	<li class="list-group-item note-item clearfix" id="note-2442479">
            		<form action="/content/update/2442479" method="post" data-id="2442479" class="note-update-form">
            			<input type="hidden" name="_method" value="PUT" id="_method">
                        <div class="content-body panel-body pull-left">
                        				<div class="note-select-indicator note-deselected">
                                            <i class="fa fa-comment"></i>
...
<div class="avatar clearfix avatar-medium ">
		...
		<div class="avatar-info">
				<a class="nickname" href="/user/info/124433" title="쿠루루루루">쿠루루루루</a>
					<div class="activity"><span class="fa fa-flash"></span> 12</div>
					<div class="date-created"><span class="timeago" title="2021-07-22T19:42:52">2021-07-22 19:42:52</span></div>
		</div>
</div>
                            <fieldset class="form">
                                <article id="note-text-2442479" class="list-group-item-text note-text">
				                    	<p>감사합니다 . 답변에 내용을 토대로 구글링한 결과 다음 결과값까지는 도출했습니다.</p><pre class="  language-java"><code class=" language-java"><span class="token punctuation">{</span>

</code>&nbsp;&nbsp;<code class=" language-java"><span class="token keyword">int</span> Lotto<span class="token punctuation">[</span><span class="token punctuation">]</span> <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">int</span><span class="token number">[6</span><span class="token punctuation">]</span><span class="token punctuation">;</span>   <span class="token comment" spellcheck="true">//로또 배열
</span></code>&nbsp;&nbsp;<code class=" language-java"><span class="token keyword">int</span> a<span class="token punctuation">;</span>		</code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code class=" language-java"><span class="token comment" spellcheck="true">//당첨숫자 주소||위치
</span></code>&nbsp;&nbsp;<code class=" language-java"><span class="token keyword">int</span> i<span class="token punctuation">;</span>		</code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code class=" language-java"><span class="token comment" spellcheck="true">//당첨숫자
</span>		
</code>&nbsp;&nbsp;&nbsp;&nbsp;<code class=" language-java"><span class="token keyword">for</span><span class="token punctuation">(</span>a<span class="token number">=0</span><span class="token punctuation">;</span>a<span class="token operator">&lt;</span>Lotto<span class="token punctuation">.</span>length<span class="token punctuation">;</span>a<span class="token operator">++</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
</code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code class=" language-java"><span class="token keyword">do</span> <span class="token punctuation">{</span>i<span class="token operator">=</span><span class="token punctuation">(</span><span class="token keyword">int</span><span class="token punctuation">)</span>Math<span class="token punctuation">.</span><span class="token function">floor<span class="token punctuation">(</span></span>Math<span class="token punctuation">.</span><span class="token function">random<span class="token punctuation">(</span></span><span class="token punctuation">)</span><span class="token number">*45</span><span class="token punctuation">)</span><span class="token punctuation">;</span><span class="token punctuation">}</span>
</code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code class=" language-java"><span class="token comment" spellcheck="true">//while(Lotto[0~5] == i);						</span></code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code class=" language-java"><span class="token comment" spellcheck="true">//[목적]배열 내 인덱스 값 전체 추출
</span></code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code class=" language-java"><span class="token comment" spellcheck="true">//while(Arrays.toString(Lotto) == i); 			</span></code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code class=" language-java"><span class="token comment" spellcheck="true">//1차 시도 = 여기에 쓰는 명령어가 아닌듯 함
</span>	</code>&nbsp;&nbsp;<code class=" language-java"><span class="token comment" spellcheck="true">//while(Lotto[0]||(Lotto[1]||(Lotto[2]||(Lotto[3]||(Lotto[4]||(Lotto[5] == i);</span></code>&nbsp;&nbsp;<code class=" language-java"><span class="token comment" spellcheck="true">//2차 시도 = 비교는 두개의값만 가능한것 같음
</span>	</code>&nbsp;&nbsp;<code class=" language-java"><span class="token comment" spellcheck="true">//while(for(int z=0;z&lt;6;z++);{Lotto[z]==i}				</span></code>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<code class=" language-java"><span class="token comment" spellcheck="true">//3차 시도 = 뇌절	
</span>			Lotto<span class="token punctuation">[</span>a<span class="token punctuation">]</span> <span class="token operator">=</span> i<span class="token punctuation">;</span>
			System<span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println<span class="token punctuation">(</span></span>Lotto<span class="token punctuation">[</span>a<span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
		<span class="token punctuation">}</span>
	<span class="token punctuation">}</span></code></pre><p>지금은 저 배열에 인덱스값을 한번에 불러올수있는 명령어를 찾는중입니다 ㅋㅋㅋ</p><p>점점 하면서 산으로 가는거 같아 속상해요 ㅜㅜ</p><p>명령어가 없는건 아니겠지요??</p>
                                </article>
                            </fieldset>
                        </div>
		...
		<div class="note-evaluate-wrapper">
				<a href="javascript://" class="note-vote-btn" role="button" data-type="assent" data-eval="true" data-id="2442479">
					<i id="note-evaluate-assent-2442479" class="fa fa-angle-up note-evaluate-assent-assent" data-placement="left" data-toggle="tooltip" title="" data-original-title="추천"></i>
				</a>
			
			<div id="content-vote-count-2442479" class="content-eval-count">0</div>
			
				<a href="javascript://" class="note-vote-btn" role="button" data-type="dissent" data-eval="true" data-id="2442479">
					<i id="note-evaluate-dissent-2442479" class="fa fa-angle-down note-evaluate-dissent-dissent" data-placement="left" data-toggle="tooltip" title="" data-original-title="반대"></i>
				</a>
		</div>
                            </div>
                        </div>
                    </form>
					<form action="/content/delete/2442479" method="post" id="note-delete-form-2442479">
							<input type="hidden" name="_csrf" value="5483808e-cec5-4b25-978e-5953710310a7">
						<input type="hidden" name="_method" value="DELETE" id="_method">
                    </form>
                </li>
            	<li class="list-group-item note-item clearfix" id="note-2442806">
...
<div class="avatar clearfix avatar-medium ">
		...
		<div class="note-evaluate-wrapper">
			...
			<div id="content-vote-count-2442806" class="content-eval-count">1</div>
            	...
            	<li class="list-group-item note-item clearfix" id="note-2443418">
...
<div class="avatar clearfix avatar-medium ">
		...
		<div class="note-evaluate-wrapper">
			...
			<div id="content-vote-count-2443418" class="content-eval-count">0</div>
            	...
            	<li class="list-group-item note-item clearfix" id="note-2444095">
            		<form action="/content/update/2444095" method="post" data-id="2444095" class="note-update-form">
            			<input type="hidden" name="_method" value="PUT" id="_method">
                        <div class="content-body panel-body pull-left">
                        				<div class="note-select-indicator note-deselected">
                                            <i class="fa fa-comment"></i>
...
<div class="avatar clearfix avatar-medium ">
		<a href="/user/info/55620" class="avatar-photo"><img src="//www.gravatar.com/avatar/700bb3a0477fc6c2dcbbe3c8653ce241?d=identicon&amp;s=40"></a>
		<div class="avatar-info">
				<a class="nickname" href="/user/info/55620" title="taeuklee">taeuklee</a>
					<div class="activity"><span class="fa fa-flash"></span> 77</div>
					<div class="date-created"><span class="timeago" title="2021-07-23T22:09:14">2021-07-23 22:09:14</span></div>
		</div>
</div>
                            <fieldset class="form">
                                <article id="note-text-2444095" class="list-group-item-text note-text">
				                    	<p>로또 당첨되게 해주세요...</p>
                                </article>
                            </fieldset>
                        </div>
		...
		<div class="note-evaluate-wrapper">
				<a href="javascript://" class="note-vote-btn" role="button" data-type="assent" data-eval="true" data-id="2444095">
					<i id="note-evaluate-assent-2444095" class="fa fa-angle-up note-evaluate-assent-assent" data-placement="left" data-toggle="tooltip" title="" data-original-title="추천"></i>
				</a>
			
			<div id="content-vote-count-2444095" class="content-eval-count">0</div>
			
				<a href="javascript://" class="note-vote-btn" role="button" data-type="dissent" data-eval="true" data-id="2444095">
					<i id="note-evaluate-dissent-2444095" class="fa fa-angle-down note-evaluate-dissent-dissent" data-placement="left" data-toggle="tooltip" title="" data-original-title="반대"></i>
				</a>
		</div>
                            </div>
                        </div>
                    </form>
					<form action="/content/delete/2444095" method="post" id="note-delete-form-2444095">
							<input type="hidden" name="_csrf" value="5483808e-cec5-4b25-978e-5953710310a7">
						<input type="hidden" name="_method" value="DELETE" id="_method">
                    </form>
                </li>
		...
		<div class="avatar-info">
				<a class="nickname" href="/user/info/124651" title="rita_dev">rita_dev</a>
					<div class="activity block"><span class="fa fa-flash"></span> 0</div>
	                        ...
	                        <h5 class="text-center" style="background-color:#FFEB3B;padding:0.5em;font-weight: bold;"><a href="/user/edit" class="link">이메일 인증</a>을 완료하여야 답변을 등록할 수 있습니다.</h5>
	                    </div>
            </li>
        </ul>
    </div>
...
<form action="/article/scrap/1004902" method="post" name="article-scrap-form" id="article-scrap-form">
                ...
                <div class="right-banner-wrapper">
	       		...
	       		<div class="google-ad">
	                   ...
	                   <!-- okjspad_160x500 -->
	                   <ins class="adsbygoogle" style="display:inline-block;width:160px;height:500px" data-ad-client="ca-pub-8103607814406874" data-ad-slot="6573675943" data-adsbygoogle-status="done" data-ad-status="filled"><ins id="aswift_1_expand" style="display:inline-table;border:none;height:500px;margin:0;padding:0;position:relative;visibility:visible;width:160px;background-color:transparent;" tabindex="0" title="Advertisement" aria-label="Advertisement"><ins id="aswift_1_anchor" style="display:block;border:none;height:500px;margin:0;padding:0;position:relative;visibility:visible;width:160px;background-color:transparent;"><iframe id="aswift_1" name="aswift_1" style="left:0;position:absolute;top:0;border:0;width:160px;height:500px;" sandbox="allow-forms allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts allow-top-navigation-by-user-activation" width="160" height="500" frameborder="0" src="https://googleads.g.doubleclick.net/pagead/ads?client=ca-pub-8103607814406874&amp;output=html&amp;h=500&amp;slotname=6573675943&amp;adk=4104151020&amp;adf=3198278716&amp;pi=t.ma~as.6573675943&amp;w=160&amp;lmt=1627189753&amp;psa=1&amp;format=160x500&amp;url=https%3A%2F%2Fokky.kr%2Farticle%2F1004902&amp;flash=0&amp;wgl=1&amp;uach=WyJXaW5kb3dzIiwiMTAuMCIsIng4NiIsIiIsIjkyLjAuNDUxNS4xMDciLFtdLG51bGwsbnVsbCxudWxsXQ..&amp;tt_state=W3siaXNzdWVyT3JpZ2luIjoiaHR0cHM6Ly9hdHRlc3RhdGlvbi5hbmRyb2lkLmNvbSIsInN0YXRlIjo3fV0.&amp;dt=1627189752817&amp;bpp=1&amp;bdt=176&amp;idt=198&amp;shv=r20210720&amp;ptt=9&amp;saldr=aa&amp;abxe=1&amp;cookie=ID%3D211a8af1bf1f530b-2234a71a69ca00c2%3AT%3D1626532296%3ART%3D1626532296%3AS%3DALNI_Ma3AoN67nu6cpRvWDd1rPPop8KXEg&amp;prev_fmts=728x90%2C0x0&amp;nras=1&amp;correlator=5026386554244&amp;frm=20&amp;pv=1&amp;ga_vid=1490288083.1626532297&amp;ga_sid=1627189753&amp;ga_hid=52732924&amp;ga_fc=0&amp;u_tz=540&amp;u_his=35&amp;u_java=0&amp;u_h=720&amp;u_w=1280&amp;u_ah=720&amp;u_aw=1280&amp;u_cd=24&amp;u_nplug=3&amp;u_nmime=4&amp;adx=1080&amp;ady=65&amp;biw=1023&amp;bih=631&amp;scr_x=0&amp;scr_y=0&amp;eid=42530672%2C20211866%2C21067496&amp;oid=3&amp;pvsid=953390727597564&amp;pem=36&amp;ref=https%3A%2F%2Fokky.kr%2Farticles%2Ftech-qna%3Foffset%3D220%26max%3D20%26sort%3Did%26order%3Ddesc&amp;eae=0&amp;fc=896&amp;brdim=0%2C0%2C0%2C0%2C1280%2C0%2C1280%2C720%2C1039%2C648&amp;vis=1&amp;rsz=%7C%7CfeE%7C&amp;abl=CF&amp;pfx=0&amp;fu=1024&amp;bc=31&amp;ifi=2&amp;uci=a!2&amp;fsb=1&amp;xpc=pjglZN037x&amp;p=https%3A//okky.kr&amp;dtd=200" marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" scrolling="no" allowfullscreen="true" data-google-container-id="a!2" data-google-query-id="CIzwzpm6_fECFUOcwgod-EYKcg" data-load-complete="true"></iframe></ins></ins></ins>
	                   <script>
	                        (adsbygoogle = window.adsbygoogle || []).push({});
	                   </script>
	               </div>
