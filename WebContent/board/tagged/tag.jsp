...
<div id="list-article" class="content scaffold-list" role="main">
	<div class="nav" role="navigation">
	    ...
	    <h4>Tagged <span class="item-tag label label-gray">redis</span></h4>
	    <div class="category-filter-wrapper">
	    	<form action="/articles/tagged/redis" method="get" name="category-filter-form" id="category-filter-form">
	            ...
	            <ul class="list-sort pull-left">
	                <li><a href="/articles/tagged/redis?query=&sort=id&order=desc" data-sort="id" data-order="desc" class="category-sort-link active">최신순</a></li>
	                <li><a href="/articles/tagged/redis?query=&sort=voteCount&order=desc" data-sort="voteCount" data-order="desc" class="category-sort-link ">추천순</a></li>
	                <li><a href="/articles/tagged/redis?query=&sort=noteCount&order=desc" data-sort="noteCount" data-order="desc" class="category-sort-link ">댓글순</a></li>
	                <li><a href="/articles/tagged/redis?query=&sort=scrapCount&order=desc" data-sort="scrapCount" data-order="desc" class="category-sort-link ">스크랩순</a></li>
	                <li><a href="/articles/tagged/redis?query=&sort=viewCount&order=desc" data-sort="viewCount" data-order="desc" class="category-sort-link ">조회순</a></li>
	            </ul>
	...
	<a href="/articles/tips" class="list-group-item-text item-tag label label-info"><i class="fa fa-code"></i> Tips & 강좌</a>
			...
			<a href="/articles/tagged/redis" class="list-group-item-text item-tag label label-gray ">redis</a>
				        </div>
				
				        <h5 class="list-group-item-heading">
				            <a href="/article/1007515">
				                [redis] redis의 트랜잭션
				            </a>
				        </h5>
				    </div>
				    ...
				    <div class="list-summary-wrapper clearfix">
				            <div class="list-group-item-summary clearfix">
				                <ul>
				                    ...
				                    <li class="">
				                        <i class="item-icon fa fa-thumbs-up"></i> 1
				                    </li>
...
<div class="avatar clearfix avatar-list ">
		<a href="/user/info/96462" class='avatar-photo'><img src="//www.gravatar.com/avatar/0e6a2e3bfa2b3b7ed5b5902cbe4aac79?d=identicon&s=30"/></a>
		<div class="avatar-info">
				<a class="nickname" href="/user/info/96462" title="사바라다">사바라다</a>
					<div class="activity"><span class="fa fa-flash"></span> 303</div>
					<div class="date-created"><span class="timeago" title="2021-07-24T18:12:03">2021-07-24 18:12:03</span></div>
		</div>
</div>
				    	</div>
				    </div>
	...
	<a href="/articles/tech-qna" class="list-group-item-text item-tag label label-info"><i class="fa fa-database"></i> Tech Q&A</a>
			...
			<a href="/articles/tagged/python3" class="list-group-item-text item-tag label label-gray ">python3</a>
			<a href="/articles/tagged/%EB%A0%88%EB%94%94%EC%8A%A4" class="list-group-item-text item-tag label label-gray ">레디스</a>
			<a href="/articles/tagged/python" class="list-group-item-text item-tag label label-gray ">python</a>
			<a href="/articles/tagged/%ED%8C%8C%EC%9D%B4%EC%8D%AC" class="list-group-item-text item-tag label label-gray ">파이썬</a>
			<a href="/articles/tagged/redis" class="list-group-item-text item-tag label label-gray ">redis</a>
				        </div>
				
				        <h5 class="list-group-item-heading">
				            <a href="/article/883598">
				                파이썬 aws redis 연동문제 에러
				            </a>
				        </h5>
				    </div>
...
<div class="avatar clearfix avatar-list ">
		<a href="/user/info/112519" class='avatar-photo'><img src="//graph.facebook.com/467994301261314/picture?width=30&height=30"/></a>
		<div class="avatar-info">
				<a class="nickname" href="/user/info/112519" title="piccaboo">piccaboo</a>
					<div class="activity"><span class="fa fa-flash"></span> 20</div>
					<div class="date-created"><span class="timeago" title="2021-03-09T10:15:27">2021-03-09 10:15:27</span></div>
		</div>
</div>
				    	</div>
				    </div>
...
<li class="list-group-item list-group-item-question list-group-has-note clearfix">
	...
	<a href="/articles/tech-qna" class="list-group-item-text item-tag label label-info"><i class="fa fa-database"></i> Tech Q&amp;A</a>
			...
			<a href="/articles/tagged/node.js" class="list-group-item-text item-tag label label-gray ">node.js</a>
...
<div class="avatar clearfix avatar-list ">
		...
		<div class="avatar-info">
				<a class="nickname" href="/user/info/124220" title="이기운">이기운</a>
					...
					<div class="date-created"><span class="timeago" title="2021-07-25T12:50:29">2021-07-25 12:50:29</span></div>
		</div>
</div>
    </div>
</li>
	...
	<a href="/articles/tech-qna" class="list-group-item-text item-tag label label-info"><i class="fa fa-database"></i> Tech Q&A</a>
			...
			<a href="/articles/tagged/redis" class="list-group-item-text item-tag label label-gray ">redis</a>
			<a href="/articles/tagged/InmemoryDB" class="list-group-item-text item-tag label label-gray ">InmemoryDB</a>
			<a href="/articles/tagged/mysql" class="list-group-item-text item-tag label label-gray ">mysql</a>
			<a href="/articles/tagged/mariadb" class="list-group-item-text item-tag label label-gray ">mariadb</a>
			<a href="/articles/tagged/mongodb" class="list-group-item-text item-tag label label-gray ">mongodb</a>
				        </div>
				
				        <h5 class="list-group-item-heading">
				            <a href="/article/807403">
...
<div class="avatar clearfix avatar-list ">
		<span class="avatar-photo"><img src='//www.gravatar.com/avatar/00000000000000000000000000000000?d=mm&s=30'/></span>
		<div class="avatar-info">
				<span class="nickname" title="vaultboy">vaultboy</span>
					<div class="activity"><span class="fa fa-lock"></span></div>
					<div class="date-created"><span class="timeago" title="2020-10-30T19:39:12">2020-10-30 19:39:12</span></div>
		</div>
</div>
				    	</div>
				    </div>
