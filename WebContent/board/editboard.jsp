...
<div class="avatar clearfix avatar-medium pull-left">
        ...
        <div class="panel-body">
        	<form action="/article/update/1007659" method="post" id="article-form" class="article-form" role="form" onsubmit="return postForm()">
...
<div class="form-group has-feedback">
    <div>
    	<input type="text" name="title" required="" value="안녕하세요" placeholder="제목을 입력해 주세요." class="form-control" id="title">
    </div>
</div>
...
<div class="form-group has-feedback">
    	<textarea name="text" id="summernote" rows="20" class="form-control input-block-level">&lt;p style=&quot;color:rgb( 51 , 51 , 51 )&quot;&gt;안녕하세요.&lt;/p&gt;&lt;p style=&quot;color:rgb( 51 , 51 , 51 )&quot;&gt;처음 글을 써보네요..반갑습니다!&lt;/p&gt;&lt;p style=&quot;color:rgb( 51 , 51 , 51 )&quot;&gt;요새 너무 날씨가 덥네요..&lt;/p&gt;&lt;p style=&quot;color:rgb( 51 , 51 , 51 )&quot;&gt;컴퓨터 앞에서 있으니 더 더운것 같아요...&lt;/p&gt;&lt;p style=&quot;color:rgb( 51 , 51 , 51 )&quot;&gt;다들 더위 조심하세요~&lt;/p&gt;&lt;p style=&quot;color:rgb( 51 , 51 , 51 )&quot;&gt;&lt;br /&gt;&lt;/p&gt;</textarea>
</div>
