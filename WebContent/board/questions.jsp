...
<head>
		...
		<script src="https://partner.googleadservices.com/gampad/cookie.js?domain=okky.kr&amp;callback=_gfp_s_&amp;client=ca-pub-8103607814406874&amp;cookie=ID%3D2b7f7fd45f7b6cd2-22e731fc2dc80057%3AT%3D1620806292%3ART%3D1620806292%3AS%3DALNI_Mb64_Oj_6UjEQlN4WTSbL_aWR-jDA"></script>
						...
						<li class="list-group-item list-group-item-question list-group-has-note clearfix">
							...
							<div class="list-title-wrapper clearfix">
	       						...
	       						<h5 class="list-group-item-heading list-group-item-evaluate">
	           						<a href="1004902.jsp">[태그 잊지말고 달기] Q&amp;A 좋은 답글 달리는 꿀팁!</a>
	       						</h5>
							</div>
	   			...
	   			<ul class="list-group ">
					...
					<li class="list-group-item list-group-item-question list-group-no-note clearfix">
	    				...
	    				<div class="list-title-wrapper clearfix">
	        				...
	        				<h5 class="list-group-item-heading list-group-item-evaluate">
	            				<a href="/article/1007592">mysql 데이터조회</a>
	        				</h5>
						</div>
    					...
    					<div class="list-summary-wrapper clearfix">
            				<div class="item-evaluate-wrapper pull-right clearfix">
		                		...
		                		<div class="item-evaluate item-evaluate-has-note">
		                    		...
		                    		<div class="item-evaluate-count">4</div>
		                		</div>
            				</div>   
						</div>
					...
					<li class="list-group-item list-group-item-question list-group-has-note clearfix">
    					<div class="list-title-wrapper clearfix">
					        ...
					        <h5 class="list-group-item-heading list-group-item-evaluate">
					            <a href="/article/1007536">배포시에 mysql의 데이터를 어떻게 받아오죠?</a>
					        </h5>
    					</div>
					...
					<li class="list-group-item list-group-item-question list-group-success clearfix">
					    ...
					    <div class="list-title-wrapper clearfix">
					        ...
					        <h5 class="list-group-item-heading list-group-item-evaluate">
					            <a href="/article/1006388">선배님들 쿠키 관련 질문드립니다.</a>
					        </h5>
					    </div>
...
<iframe id="google_osd_static_frame_6427854703668" name="google_osd_static_frame" style="display: none; width: 0px; height: 0px;"></iframe>
