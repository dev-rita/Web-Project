...
<div class="avatar clearfix avatar-medium pull-left">
	   ...
	   <div class="panel-body">
	   		<form action="/articles/questions/save" method="post" id="article-form" class="article-form" role="form" onsubmit="return postForm()">
	           <fieldset class="form">
            ...
            <div>
                <select id="category" name="categoryCode" class="form-control" required="">
                    <option value="">게시판을 선택해 주세요.</option>
                        <option value="tech-qna"
                                
                                data-external="false"
                                data-anonymity="false">
Tech Q&A                        </option>
                        <option value="blockchain-qna"
