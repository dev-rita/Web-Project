...
<html lang="ko" class="no-js"><!--<![endif]--><head>
	...
	<script src="https://www.googletagservices.com/activeview/js/current/osd.js"></script><script src="https://partner.googleadservices.com/gampad/cookie.js?domain=okky.kr&amp;callback=_gfp_s_&amp;client=ca-pub-8103607814406874&amp;cookie=ID%3Dc76794c62709098a-22b825815bca000d%3AT%3D1626432631%3ART%3D1626432631%3AS%3DALNI_MZ_3LnDaxAJzzhGjq5C0v5-svo6zQ"></script><script src="https://pagead2.googlesyndication.com/pagead/managed/js/adsense/m202107220101/show_ads_impl.js?bust=31061979" id="google_shimpl"></script><script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script><script async="" src="https://www.googletagmanager.com/gtm.js?id=GTM-M52CW55"></script><script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
...
<div class="avatar clearfix avatar-big col-sm-3 text-center">
          ...
          <div class="user-info col-sm-9">
              ...
              <div class="user-points">
                  <div class="user-point">
                      ...
                      <div class="user-point-num"><a href="/user/info/123563/activity">0</a></div>
                  </div>
                  <div class="user-point">
  ...
  <div class="col-sm-2 user-info-nav pull-right">
      <ul class="nav">
          <li class="active"><a href="/user/info/123563/activity">최근 활동</a> </li>
