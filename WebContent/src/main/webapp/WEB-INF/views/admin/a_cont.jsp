        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content" >
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800" >${b.b_cate}</h1>
               ...
               <div class="panel-heading clearfix">
                  <div class="avatar">
                     <a href="/user/info/124651" class='avatar-photo'>
                        ...
                        <a class="nickname" href="/user/info/124651" title="${b.b_name}" id="nickname">${b.b_name}</a>
                        
                           <span class="fa fa-flash"></span> 0
                       <div><span title="${b.b_date}">${b.b_date}</span></div>
               ...
               <div class="panel-body">
                        ...
                        <div class="form-group has-feedback">
                          <div class="content-tags">
	                    	...
	                    	<!-- 태그 시작-->
							<a href="${b.b_cate == '커뮤니티' ? 'b_community' : 'b_questions'}" class="tag tag-info"><i class="fa fa-database"></i> ${b.b_cate}</a>
                        ...
                        <div class="form-group has-feedback">
                          ...
                          <a class="listbtn btn btn-info"  onclick="location='${b.b_cate == '커뮤니티' ? 'a_community' : 'a_questions'}?page=${page}';" > 목록</a>
                        </div>
...
function getAllList(){
	...
	$.getJSON("/controller/all/"+b_no,function(data){
		...
		$(data).each(function(){//each()함수로 반복
		    ...
		    +"<span class='fa fa-flash'></span> 352"+"<div class='replyLi' data-r_no='"+this.r_no+"' style='display:none;'>"+this.r_no+"</div>"
		    +"<div class='date-created'><span class='timeago' title='"+this.regdate+"'>"+this.regdate+"</span></div>"
		    +"</div><fieldset class='form'><article id='note-text-"+this.r_no+"' class='list-group-item-text note-text'>"
			+this.replytext+"</article></fieldset></div></li>"
