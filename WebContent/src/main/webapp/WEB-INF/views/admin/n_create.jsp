               ...
               <div class="panel-body">
                  ...
                  id="article-form" class="article-form" role="form" onsubmit="return postForm()">
                     <fieldset class="form">
                        ...
                        <script>
                        document.getElementById('n_name').value=document.getElementById('nickname').textContent;
                        
                        </script>
                        <div class="form-group has-feedback">
                           <div>
                              
                              <select id="category" name="n_cate" class="form-control" required="">
                                 <option value="Q&A" data-external="false"
								data-anonymity="false"<c:if test="${b.n_cate=='공지사항'}">${'selected'}</c:if>>공지사항</option>
                        ...
                        <div class="form-group has-feedback">
                           <div>
                              <input type="text" name="n_title" required="" value=""
                        ...
                        <div class="form-group has-feedback">
                           <textarea name="n_cont" id="summernote" rows="20"
                              class="form-control input-block-level"></textarea>
                           <input type="hidden" name="textType" value="HTML" id="textType">                           
                           <div class="nav" role="navigation">
                              <fieldset class="buttons">
                                 <a href="javascript:window.history.back();" class="btn btn-danger btn-wide" 
...
<script src="./resources/js/application.js" type="text/javascript"></script>
	...
	<script type="text/javascript">
		$('input[name=n_tag]').tagsinput(tagsInputConfig);
		$('input[name=n_tag]').on('itemAdded', tagsInputItemAddedEventCallback);
