			...
			<div id="article-edit" class="content" role="main">
	    		<div class="panel panel-default clearfix">
        			<div class="panel-heading clearfix">
            			...
            			<input type="hidden" name="n_no" value="${b.n_no}" />
                			
            			</div>
        			</div>
        			<div class="panel-body">
        				<form action="n_edit_ok?n_no=${b.n_no}&page=${page}" method="post" id="article-form" 
        				class="article-form" role="form" onsubmit="return postForm()">
                			...
                			<fieldset class="form">
								...
								<div class="form-group has-feedback">
    								<div>
    									<input type="text" name="n_title" required="" value="${b.n_title}"
