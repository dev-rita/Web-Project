         ...
         <div id="create-user" class="content clearfix" role="main">
            ...
            <div class="col-md-6 main-block-left">
               <div class="panel panel-default">
                  ...
                  <form action="editinfo_ok" method="POST" onsubmit="return editinfo_check();" class="form-signup form-user panel-body" id="loginForm" autocomplete="off">
                     <%--
                     ...
                     <fieldset>
                        <div class="form-group">
                           ...
                           <input type="text" name="mem_name" id="fullName" class="form-control input-sm" placeholder="이름" required value="${m.mem_name}" >
                           <span id="namecheck"></span>
                        </div>
                        <div class="form-group">
                           <label class="control-label" for="nick">닉네임</label>
                           <input type="text" id="nick" name="mem_nick" class="form-control input-sm" placeholder="닉네임" required value="${m.mem_nick}">
                        ...
                        <div class="form-group"><%-- 아이디는 수정 안되게끔 한다. --%>
                           <p class="control-label"><b>아이디</b></p>
