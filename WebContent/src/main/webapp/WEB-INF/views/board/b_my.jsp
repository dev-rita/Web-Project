...
<div class="avatar clearfix avatar-big col-sm-3 text-center">
		<a href="/user/info/124651" class="avatar-photo"><img src="//www.gravatar.com/avatar/8a9fd42ec1c99aeb1b1ba542521de04e?d=identicon&amp;s=150"></a>
          ...
          <div class="user-info col-sm-9">
              <div class="clearfix">
                  <h2 class="pull-left">rita_dev</h2>
              ...
              <div class="user-points">
                  <div class="user-point">
                      ...
                      <div class="user-point-num"><a href="/user/info/124651/activity">12</a></div>
                  </div>
                  <div class="user-point">
  ...
  <div class="col-sm-2 user-info-nav pull-right">
      <ul class="nav">
          <li class="active"><a href="/user/info/124651/activity">최근 활동</a> </li>
          <li class=""><a href="/user/info/124651/articles">게시물 <span class="badge">1</span></a></li>
          <li class=""><a href="/user/info/124651/scrapped">스크랩 </a></li>
      </ul>
  </div>
                  ...
                  <div class="list-title-wrapper list-activity">
                      <div class="list-activity-desc">
                          <span class="list-activity-desc-text">
                          	#1007659 게시물을 추천 하였습니다.
                          
                          
                          
                          </span>
                          <span class="timeago" title="2021-09-09T21:33:51">2021-09-09 21:33:51</span>
                      </div>
                      <h5 class="list-group-item-heading">
                      	  <a href="/article/1007659">안녕하세요</a>
